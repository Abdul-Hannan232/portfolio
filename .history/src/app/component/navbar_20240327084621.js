...
const Navbar = () => {
    ...
    return (
        <div className={`md:w-[800px] fixed top-0 right-0 left-0 z-4    0 px-3 rounded-b-2xl pb-3  mx-auto pt-10 ${scrolled ? 'bg-gray-900 shadow-xl px-3 rounded-b-2xl pb-3 backdrop-blur-xl bg-white/30' : 'bg-transparent'}`}>
