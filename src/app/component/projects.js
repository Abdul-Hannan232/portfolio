...
const Projects = () => {
    ...
    return (
        <motion.div whileInView={{ y: 0 }} initial={{ y:100 }} transition={{ delay: 0.2, duration: 1 }} id="projects" className="pt-10">
            ...
            {CategoryData.map((item)=>(
                <div onClick={(e) => filteredCategory(e.target.textContent)} className="hover:bg-[#2D8CFF] text-white md:rounded-xl rounded-md md:w-28 poppins-semibold md:text-sm text-[8px] text-center md:py-3 px-2 py-1">
                {item.category}
            </div>
            ))}  
            </div>
            <div>
                        ...
                        if (ProjectData.length === 1) {
                            return <>
                                <Link target="_blank" href={item.link} className="cursor-pointer ">
                                    <div className=" md:ml-12 mt-5 blackBox shadow-xl relative">
                            ...
                            if (manageRow % 2 === 0) {
                                    ...
                                    return (
                                        <div key={index} className={`my-3 mx-auto relative md:ml-12 ${showAllItems || index  < displayCount ? '' : 'hidden'}`}>
                                            <Link target="_blank" href={ProjectData[index + 1].link} className="cursor-pointer ">
                                                <div className={`md:ml-14 bg-[#2D8CFF] rounded-xl md:w-[270px] md:mt-0 mt-5 relative w-[80%] mx-auto md:p-5 p-4 cursor-pointer`}>
                                            ...
                                            <Link target="_blank" href={item.link} className="cursor-pointer ">
                                                <div className="md:-ml-44 mt-5 blackBox shadow-xl relative">
                                                    <Image src={item.image_name} alt="project1" width={461} height={213} className={`transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 z-10 cursor-pointer${index % 2 === 0 ? "md:w-[461px] md:h-[213px] h-[160px]" : "md:w-[225px] md:h-[213px] h-[180px]"}`} />
                                                    <Link target="_blank" href={item.link} className="cursor-pointer ">
                                                        <Image src="/export.png" alt="icon" width={16} height={18} className={`w-auto cursor-pointer  absolute bg-[#2D8CFF] p-1 rounded-md shadow-xl  md:top-8 top-12 md:right-8 right-14 ${index % 2 === 0 ? "z-20" : ""}`} />
                                                    </Link>
                                ...
                                if (index % 2 === 0) {
                                    ...
                                    return (
                                        <div key={index} className={`my-3 mx-auto relative md:ml-12 ${showAllItems || index < displayCount ? '' : 'hidden'}`}>
                                            <Link target="_blank" href={ProjectData[index + 1].link} className="cursor-pointer ">
                                                <div className="blackBox shadow-xl relative">
                                                    <Image src={ProjectData[index + 1].image_name} alt="project1" width={461} height={213} className={`transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 z-10 cursor-pointer${index % 2 === 0 ? "md:w-[461px] md:h-[213px] h-[160px]" : "md:w-[225px] md:h-[213px] h-[180px]"}`} />
                                                    <Link target="_blank" href={ProjectData[index + 1].link} className="cursor-pointer ">
                                                        <Image src="/export.png" alt="icon" width={16} height={18} className={`  w-auto cursor-pointer  absolute bg-[#2D8CFF] p-1 rounded-md shadow-xl  md:top-8 top-12 md:right-8 right-14 ${index % 2 === 0 ? "z-20" : ""}`} />
                                                    </Link>
                                            ...
                                            <Link target="_blank" href={item.link} className="cursor-pointer">
                                                <div className="md:-ml-1 mt-5  bg-[#2D8CFF] rounded-xl md:w-[270px]  w-[80%] relative mx-auto md:p-5 p-4 cursor-pointer">
                                                    <Image src={item.image_name} alt="project1" width={461} height={213} className={`transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 z-10 cursor-pointer${index % 2 === 0 ? "md:w-[461px] md:h-[213px] h-[160px]" : "md:w-[225px] md:h-[213px] h-[180px]"}`} />
                                                    <Link target="_blank" href={item.link} className="cursor-pointer ">
                                                        <Image src="/export.png" alt="icon" width={20} height={20} className={`w-auto cursor-pointer  absolute bg-[#2D8CFF] p-1 rounded-md shadow-xl top-8 right-8 z-20 `} />
                                                    </Link>
                                                    <h1 className="md:text-[30px] text-2xl font-bold md:my-5 my-3 text-[#FFFFFF] poppins-bold">{item.project_name}</h1>
                                                    <button className="text-[#CACACA] bg-[#FFFFFF] bg-opacity-20 rounded-md poppins-semibold py-2 text-[11px]  md:w-36 w-36 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 cursor-pointer">{item.category}</button>
                                                </div>
                ...
                {!showAllItems && (
                    <div className="md:w-[800px] md:mx-auto mx-10 flex justify-center items-center gap-1 cursor-pointer bg-black text-white rounded-xl py-3 mt-3" onClick={handleViewMore}>
                        <p>View More</p>
                ...
                {showAllItems && (
                    <div className="md:w-[800px] md:mx-auto mx-10 flex justify-center items-center gap-1 cursor-pointer bg-black text-white rounded-xl py-3 mt-3" onClick={handleViewLess}>
                        <p>View Less</p>
