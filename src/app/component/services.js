        ...
        <motion.div whileInView={{ y: 0 }} initial={{ y: 100 }} transition={{ delay: 0.2, duration: 1 }}  id="services" className='pt-10' >
            ...
            <div className='md:w-[800px]  md:mx-auto mx-5'>
                ...
                {service.map((item,index) => (
                    ...
                    <div className={`md:flex items-center transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105  duration-300 justify-evenly  mt-6 w-full p-5  md:h-52 rounded-2xl ${index % 2 === 0 ? 'bg-[#2D8CFF] text-white' : 'bg-white text-[#787878] border-[#CACACA] border-2'} `}>
